        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btn.setOnClickListener(new View.OnClickListener(){
                public void onClick(View v){
                    String url1 = "https://api.edamam.com/search?q=COFFEE&app_id=42e47428&app_key=c4dcd279be1a311cc7f745f99ff17f42&from=0&to=1";
                    RequestQueue requestQueue = newRequestQueue(SearchItem.this);
                    JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url1, null, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                Toast.makeText(SearchItem.this, "not possible Vinay", Toast.LENGTH_LONG).show();
                            }
                        }
